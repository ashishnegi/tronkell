...
var _user$project$Grid_Player$Player = F6(
	function (a, b, c, d, e, f) {
		return {id: a, name: b, color: c, orientation: d, alive: e, trail: f};
	});
var _user$project$Grid_Player$West = {ctor: 'West'};
var _user$project$Grid_Player$South = {ctor: 'South'};
var _user$project$Grid_Player$East = {ctor: 'East'};
var _user$project$Grid_Player$North = {ctor: 'North'};

var _user$project$Grid_Message$NoOp = {ctor: 'NoOp'};
var _user$project$Grid_Message$PlayerDied = function (a) {
	return {ctor: 'PlayerDied', _0: a};
};
var _user$project$Grid_Message$PlayerMoved = F3(
	function (a, b, c) {
		return {ctor: 'PlayerMoved', _0: a, _1: b, _2: c};
	});

var _user$project$Grid_Model$Grid = F3(
	function (a, b, c) {
		return {width: a, height: b, playerCells: c};
	});
var _user$project$Grid_Model$init = F3(
	function (w, h, playerCells) {
		return A3(_user$project$Grid_Model$Grid, w, h, playerCells);
	});
var _user$project$Grid_Model$PlayerCell = F2(
	function (a, b) {
		return {player: a, pos: b};
	});
var _user$project$Grid_Model$Cell = F2(
	function (a, b) {
		return {ctype: a, pos: b};
	});
var _user$project$Grid_Model$TrailCellType = function (a) {
	return {ctor: 'TrailCellType', _0: a};
};
var _user$project$Grid_Model$PlayerCellType = function (a) {
	return {ctor: 'PlayerCellType', _0: a};
};
var _user$project$Grid_Model$EmptyCellType = {ctor: 'EmptyCellType'};
var _user$project$Grid_Model$gridToList = function (grid) {
	var playerToTrailCell = function (p) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Grid_Model$Cell(
				_user$project$Grid_Model$TrailCellType(p.player.color)),
			p.player.trail);
	};
	return _elm_lang$core$List$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$core$List$map,
				_user$project$Grid_Model$Cell(_user$project$Grid_Model$EmptyCellType),
					...
					A2(
						...
						function (w) {
							return A2(
								_elm_lang$core$List$map,
								function (h) {
									return {ctor: '_Tuple2', _0: w, _1: h};
								},
								_elm_lang$core$Native_List.range(0, grid.height - 1));
						},
						_elm_lang$core$Native_List.range(0, grid.width - 1)))),
				A2(_elm_lang$core$List$concatMap, playerToTrailCell, grid.playerCells),
				A2(
				_elm_lang$core$List$map,
				function (p) {
					return A2(
						_user$project$Grid_Model$Cell,
						_user$project$Grid_Model$PlayerCellType(p.player),
						p.pos);
				},
				grid.playerCells)
			]));
...
var _user$project$Grid_Update$updatePlayer = F3(
	function (pid, f, playerCells) {
		return A2(
			_elm_lang$core$List$map,
			function (pc) {
				return _elm_lang$core$Native_Utils.eq(pc.player.id, pid) ? f(pc) : pc;
			},
			playerCells);
	});
var _user$project$Grid_Update$playerDied = F2(
	function (pid, playerCells) {
		return A3(
			_user$project$Grid_Update$updatePlayer,
			pid,
			function (pc) {
				var p = pc.player;
...
var _user$project$Grid_Update$addPos = F4(
	function (pid, pos$, orien, playerCells) {
		return A3(
			_user$project$Grid_Update$updatePlayer,
			pid,
			function (pc) {
			...
			case 'PlayerMoved':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						grid,
						{
							playerCells: A4(_user$project$Grid_Update$addPos, _p0._0, _p0._1, _p0._2, grid.playerCells)
						}),
			...
			case 'PlayerDied':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						grid,
						{
							playerCells: A2(_user$project$Grid_Update$playerDied, _p0._0, grid.playerCells)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Grid_View$colorOfCell = function (cell) {
	var _p0 = cell.ctype;
	switch (_p0.ctor) {
		case 'EmptyCellType':
			return _elm_lang$core$Color$grey;
		case 'PlayerCellType':
			return _p0._0.alive ? _elm_lang$core$Color$green : _elm_lang$core$Color$red;
		default:
			return _p0._0;
	}
};
var _user$project$Grid_View$fillCell = F2(
	function (cell, shape) {
		return A2(
			_evancz$elm_graphics$Collage$filled,
			_user$project$Grid_View$colorOfCell(cell),
			shape);
	});
var _user$project$Grid_View$bringToCorner = F2(
	function (_p2, _p1) {
		var _p3 = _p2;
		var _p4 = _p1;
		return {ctor: '_Tuple2', _0: _p4._0 - (_p3._0 / 2), _1: (_p3._1 / 2) - _p4._1};
	});
var _user$project$Grid_View$playerInfoView = function (cell) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(cell.player))
			]));
};
var _user$project$Grid_View$cellHeight = 10;
var _user$project$Grid_View$cellWidth = 10;
var _user$project$Grid_View$cellStructure = function (cell) {
	var _p5 = cell.ctype;
	switch (_p5.ctor) {
		case 'EmptyCellType':
			return _evancz$elm_graphics$Collage$square(_user$project$Grid_View$cellWidth - 1);
		case 'PlayerCellType':
			return A2(_evancz$elm_graphics$Collage$oval, _user$project$Grid_View$cellWidth - 1, _user$project$Grid_View$cellHeight - 1);
		default:
			return A2(_evancz$elm_graphics$Collage$oval, _user$project$Grid_View$cellHeight - 1, _user$project$Grid_View$cellWidth - 1);
	}
};
var _user$project$Grid_View$renderCell = F2(
	function (b, cell) {
		var _p6 = A2(_user$project$Grid_View$bringToCorner, b, cell.pos);
		var cx = _p6._0;
		var cy = _p6._1;
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: cx * _user$project$Grid_View$cellWidth, _1: cy * _user$project$Grid_View$cellHeight},
			A2(
				_user$project$Grid_View$fillCell,
				cell,
				_user$project$Grid_View$cellStructure(cell)));
	});
var _user$project$Grid_View$view = function (grid) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Playground')
					])),
				_evancz$elm_graphics$Element$toHtml(
				A3(
					_evancz$elm_graphics$Collage$collage,
					_elm_lang$core$Basics$round((grid.width + 1) * _user$project$Grid_View$cellWidth),
					_elm_lang$core$Basics$round((grid.height + 1) * _user$project$Grid_View$cellHeight),
					A2(
						_elm_lang$core$List$map,
						_user$project$Grid_View$renderCell(
							{ctor: '_Tuple2', _0: grid.width, _1: grid.height}),
						_user$project$Grid_Model$gridToList(grid)))),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _user$project$Grid_View$playerInfoView, grid.playerCells))
			]));
};

var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {grid: a, nick: b, myId: c, winnerId: d, wsserver: e};
	});

var _user$project$Message$NoOp = {ctor: 'NoOp'};
var _user$project$Message$GridMsg = function (a) {
	return {ctor: 'GridMsg', _0: a};
};
var _user$project$Message$ServerMsg = function (a) {
	return {ctor: 'ServerMsg', _0: a};
};
var _user$project$Message$PlayerRegisterId = function (a) {
	return {ctor: 'PlayerRegisterId', _0: a};
};
var _user$project$Message$GameEnded = function (a) {
	return {ctor: 'GameEnded', _0: a};
};
var _user$project$Message$GameReady = F3(
	function (a, b, c) {
		return {ctor: 'GameReady', _0: a, _1: b, _2: c};
	});
var _user$project$Message$MoveDown = {ctor: 'MoveDown'};
var _user$project$Message$MoveUp = {ctor: 'MoveUp'};
var _user$project$Message$MoveRight = {ctor: 'MoveRight'};
var _user$project$Message$MoveLeft = {ctor: 'MoveLeft'};
var _user$project$Message$PlayerQuit = {ctor: 'PlayerQuit'};
var _user$project$Message$PlayerReady = {ctor: 'PlayerReady'};
var _user$project$Message$RegisterNick = {ctor: 'RegisterNick'};
var _user$project$Message$PlayerName = function (a) {
	return {ctor: 'PlayerName', _0: a};
};

var _user$project$ServerMsg$changeColorOfPlayerCell = F2(
	function (cell, c) {
		var p = cell.player;
		var p$ = _elm_lang$core$Native_Utils.update(
			p,
...
var _user$project$ServerMsg$encodeMsg = function (msg) {
	var msgObject = function () {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'PlayerReady':
				return _elm_lang$core$Maybe$Just(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'type',
							_1: _elm_lang$core$Json_Encode$string('Ready')
						}
						]));
			case 'PlayerName':
				return _elm_lang$core$Maybe$Just(
				...
				return _elm_lang$core$Maybe$Just(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'type',
							_1: _elm_lang$core$Json_Encode$string('Exit')
						}
						]));
			case 'MoveLeft':
				return _elm_lang$core$Maybe$Just(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'type',
							_1: _elm_lang$core$Json_Encode$string('Left')
						}
						]));
			case 'MoveRight':
				return _elm_lang$core$Maybe$Just(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'type',
							_1: _elm_lang$core$Json_Encode$string('Right')
						}
						]));
			default:
				return _elm_lang$core$Maybe$Nothing;
	...
	var _p1 = A2(_elm_lang$core$Debug$log, 'sending', msgObject);
	if (_p1.ctor === 'Just') {
		return A2(
			_elm_lang$core$Json_Encode$encode,
			0,
			_elm_lang$core$Json_Encode$object(_p1._0));
	} else {
		return '';
	}
};
var _user$project$ServerMsg$decodeOrientation = A2(
	...
	function (s) {
		return _elm_lang$core$Json_Decode$succeed(
			function () {
				...
				switch (_p2) {
					case 'North':
						return _user$project$Grid_Player$North;
					case 'East':
						return _user$project$Grid_Player$East;
					case 'South':
						return _user$project$Grid_Player$South;
					case 'West':
						return _user$project$Grid_Player$West;
					default:
						return _user$project$Grid_Player$North;
				}
			}());
	});
var _user$project$ServerMsg$decodeConfig = A3(
...
var _user$project$ServerMsg$decodePosition = A3(
	_elm_lang$core$Json_Decode$object2,
	F2(
		function (x, y) {
			return {ctor: '_Tuple2', _0: x, _1: y};
...
var _user$project$ServerMsg$decodeList = function (decoders) {
	return A2(
...
var _user$project$ServerMsg$decodePlayer = function (color) {
	return A5(
		_elm_lang$core$Json_Decode$object4,
		F4(
			function (id, name, coord, o) {
				return A2(
					_user$project$Grid_Model$PlayerCell,
					A6(
						_user$project$Grid_Player$Player,
						id,
						name,
						color,
						o,
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'coordinate', _user$project$ServerMsg$decodePosition),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'orientation', _user$project$ServerMsg$decodeOrientation));
};
var _user$project$ServerMsg$decodePlayers = function (colors) {
	return _user$project$ServerMsg$decodeList(
		A2(_elm_lang$core$List$map, _user$project$ServerMsg$decodePlayer, colors));
};
var _user$project$ServerMsg$nullOr = function (decoder) {
...
var _user$project$ServerMsg$decodeMsg = F2(
	function (colors, json) {
		var decodeMsg = function (msgType) {
			...
			switch (_p3) {
					...
					return A3(
						...
						F2(
							function (_p4, ps) {
								var _p5 = _p4;
								return A3(
									_user$project$Message$GameReady,
									_p5._0,
									_p5._1,
									A3(_elm_lang$core$List$map2, _user$project$ServerMsg$changeColorOfPlayerCell, ps, colors));
							}),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'config', _user$project$ServerMsg$decodeConfig),
						A2(
							_elm_lang$core$Json_Decode_ops[':='],
							'players',
							_user$project$ServerMsg$decodePlayers(colors)));
				case 'GameEnded':
					return A2(
						_elm_lang$core$Json_Decode$object1,
						_user$project$Message$GameEnded,
						A2(
							_elm_lang$core$Json_Decode_ops[':='],
							'winnerId',
							_user$project$ServerMsg$nullOr(_elm_lang$core$Json_Decode$int)));
				case 'PlayerDied':
					return A2(
						_elm_lang$core$Json_Decode$object1,
						function (id) {
							return _user$project$Message$GridMsg(
								_user$project$Grid_Message$PlayerDied(id));
						},
						A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int));
				case 'PlayerMoved':
					return A4(
						...
						F3(
							function (id, coordinate, orientation) {
								return _user$project$Message$GridMsg(
									A3(_user$project$Grid_Message$PlayerMoved, id, coordinate, orientation));
							}),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'coordinate', _user$project$ServerMsg$decodePosition),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'orientation', _user$project$ServerMsg$decodeOrientation));
				case 'ServerMsg':
					return A2(
						_elm_lang$core$Json_Decode$object1,
						_user$project$Message$ServerMsg,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'message', _elm_lang$core$Json_Decode$string));
				case 'PlayerRegisterId':
					return A2(
						_elm_lang$core$Json_Decode$object1,
						_user$project$Message$PlayerRegisterId,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int));
				default:
					return _elm_lang$core$Json_Decode$succeed(_user$project$Message$NoOp);
			}
		};
		var decoder = A2(
			_elm_lang$core$Json_Decode$andThen,
		...
		var res = A2(
			...
			decoder,
			A2(_elm_lang$core$Debug$log, 'received json: ', json));
		var _p6 = A2(_elm_lang$core$Debug$log, 'servermsg: ', res);
		if (_p6.ctor === 'Ok') {
			return _p6._0;
		} else {
			return _user$project$Message$NoOp;
		}
	});
var _user$project$ServerMsg$sendServerMsg = F2(
	function (wsserver, msg) {
		return A2(
			_elm_lang$websocket$WebSocket$send,
			wsserver,
			_user$project$ServerMsg$encodeMsg(msg));
	});
var _user$project$ServerMsg$playerColors = A2(
	_elm_lang$core$List$append,
	_elm_lang$core$Native_List.fromArray(
		[_elm_lang$core$Color$yellow, _elm_lang$core$Color$blue, _elm_lang$core$Color$brown]),
	A2(_elm_lang$core$List$repeat, 100, _elm_lang$core$Color$black));
var _user$project$ServerMsg$listenServerMsg = function (wsserver) {
	return A2(
		_elm_lang$websocket$WebSocket$listen,
		wsserver,
		_user$project$ServerMsg$decodeMsg(_user$project$ServerMsg$playerColors));
};

var _user$project$Update$getMoveCmd = F2(
	function (model, msg) {
		var getMoveCmd$ = F2(
			function (orien, msg) {
				var nextMove = function () {
					var _p0 = {ctor: '_Tuple2', _0: orien, _1: msg};
					switch (_p0._0.ctor) {
						case 'North':
							switch (_p0._1.ctor) {
								case 'MoveLeft':
									return _elm_lang$core$Maybe$Just(_user$project$Message$MoveLeft);
								case 'MoveRight':
									return _elm_lang$core$Maybe$Just(_user$project$Message$MoveRight);
								default:
									return _elm_lang$core$Maybe$Nothing;
							}
						case 'South':
				...
				var log_ = A2(
					...
					'orien, msg, nextMove : ',
					{ctor: '_Tuple3', _0: orien, _1: msg, _2: nextMove});
				var _p1 = nextMove;
				if (_p1.ctor === 'Nothing') {
					return _elm_lang$core$Platform_Cmd$none;
				} else {
					return A2(_user$project$ServerMsg$sendServerMsg, model.wsserver, _p1._0);
				}
			});
		var _p2 = {ctor: '_Tuple2', _0: model.myId, _1: model.grid};
		if (((_p2.ctor === '_Tuple2') && (_p2._0.ctor === 'Just')) && (_p2._1.ctor === 'Just')) {
			var mes = A2(
				_elm_lang$core$List$filter,
				function (pc) {
					return _elm_lang$core$Native_Utils.eq(pc.player.id, _p2._0._0);
				},
				_p2._1._0.playerCells);
			var _p3 = mes;
			if ((_p3.ctor === '::') && (_p3._1.ctor === '[]')) {
				return A2(getMoveCmd$, _p3._0.player.orientation, msg);
			} else {
				return _elm_lang$core$Platform_Cmd$none;
			}
		} else {
...
var _user$project$Update$registerNickCmd = function (model) {
	var _p4 = model.nick;
	if (_p4.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Cmd$none;
	} else {
		...
		return (_elm_lang$core$Native_Utils.cmp(
			...
			0) > 0) ? A2(
			_user$project$ServerMsg$sendServerMsg,
			model.wsserver,
			_user$project$Message$PlayerName(_p5)) : _elm_lang$core$Platform_Cmd$none;
	}
};
			...
			case 'PlayerName':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							nick: _elm_lang$core$Maybe$Just(_p6._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RegisterNick':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Update$registerNickCmd(model)
				};
			case 'PlayerReady':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$ServerMsg$sendServerMsg, model.wsserver, _user$project$Message$PlayerReady)
				};
			case 'PlayerQuit':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$ServerMsg$sendServerMsg, model.wsserver, _user$project$Message$PlayerQuit)
				};
			case 'MoveLeft':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Update$getMoveCmd, model, _user$project$Message$MoveLeft)
				};
			case 'MoveRight':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Update$getMoveCmd, model, _user$project$Message$MoveRight)
				};
			case 'MoveUp':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Update$getMoveCmd, model, _user$project$Message$MoveUp)
				};
			case 'MoveDown':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Update$getMoveCmd, model, _user$project$Message$MoveDown)
				};
			case 'GameReady':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							grid: _elm_lang$core$Maybe$Just(
								A3(_user$project$Grid_Model$init, _p6._0, _p6._1, _p6._2))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'GameEnded':
			...
			case 'PlayerRegisterId':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							myId: _elm_lang$core$Maybe$Just(_p6._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ServerMsg':
			...
			case 'GridMsg':
				return A2(
					...
					A2(
						...
						function (gg) {
							var _p7 = A2(_user$project$Grid_Update$update, _p6._0, gg);
							var g$ = _p7._0;
							var m$ = _p7._1;
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										grid: _elm_lang$core$Maybe$Just(g$)
									}),
								_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Message$GridMsg, m$)
							};
						},
						model.grid));
			default:
				...
				[
					...
					[
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Waiting for your inputs...')
								])),
						A2(
							_elm_lang$core$Maybe$map,
							function (_p0) {
								return A2(
									...
									_user$project$Message$GridMsg,
									_user$project$Grid_View$view(_p0));
							},
							model.grid))
					]),
					_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Register with a nick..'),
								A2(
								_elm_lang$html$Html$input,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onInput(_user$project$Message$PlayerName),
										_elm_lang$html$Html_Attributes$placeholder('Take a nick')
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onClick(_user$project$Message$RegisterNick)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Send Ready when you are ready to join the game !!!'),
										A2(
										_elm_lang$html$Html$button,
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Events$onClick(_user$project$Message$PlayerReady)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Events$onClick(_user$project$Message$PlayerQuit)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Quit')
											]))
									]))
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('my-id: '),
										_elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(model.myId))
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(model.nick))
									]))
							]))
					])
				])));
...
var _user$project$Subscription$keyToMsg = function (keycode) {
	var _p0 = keycode;
	switch (_p0) {
		case 37:
			return _user$project$Message$MoveLeft;
		case 38:
			return _user$project$Message$MoveUp;
		case 39:
			return _user$project$Message$MoveRight;
		case 40:
			return _user$project$Message$MoveDown;
		default:
			return _user$project$Message$NoOp;
	}
};
var _user$project$Subscription$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$keyboard$Keyboard$ups(_user$project$Subscription$keyToMsg),
				_user$project$ServerMsg$listenServerMsg(model.wsserver)
			]));
};

var _user$project$Main$init = function (wsserver) {
	return {
		ctor: '_Tuple2',
		_0: A5(_user$project$Model$Model, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, wsserver),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
